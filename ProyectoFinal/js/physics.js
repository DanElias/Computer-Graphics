Game.init = function () {
    ...
    this.knot = new THREE.Mesh(
        new THREE.TorusKnotGeometry(0.5, 0.1), this.materials.jupiter);
    ...
    this.vertex = new Body(1, {x: 0, y: 0, z: 0}, {x: 0, y: 0, z: 0}, 3, 0.55, 0xffffff,  Game.materials.earth, 0, false, 400, this.root, false, false, "earth");//149);

    this.sphere = new THREE.Mesh(
        new THREE.SphereGeometry(1, 40, 40), this.materials.jupiter);
...
Game.update = function (delta) {
    ...
    // reset materials
    this.sphere.material = this.materials.jupiter;
    this.knot.material = this.materials.jupiter;
    this.cube.material = this.materials.jupiter;
